<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <div class="form-group">
    <label for="brandName" class="col-sm-2 control-label">Update Brand</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <div class="row" style="margin:20px 0 0 0; width:240px;float:right;">
      <form:button type="submit" class="btn btn-default myButtons" name="action">Update</form:button>
