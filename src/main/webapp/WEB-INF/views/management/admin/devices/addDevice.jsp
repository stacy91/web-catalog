...
<form:select path="brand" id="brandDD" class="form-control">
  ...
  <div class="form-group">
    ...
    <form:input path="model"  class="form-control" id="modelTXT" placeholder="Enter model..."/>
  </div>
  <div class="form-group">
    <label for="priceTXT">Price</label>
    <form:input path="price"  class="form-control" id="priceTXT" placeholder="Enter price..."/>
  </div>
  <div class="form-group">
    <label for="amountTXT">Amount</label>
    <input  path="amountInStock" class="form-control" id="amountTXT" placeholder="Enter amount...">
  </div>
  <div class="form-group">
